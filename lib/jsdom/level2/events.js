...
events.EventTarget.prototype = {
    addEventListener: function(type, listener, capturing) {
        ...
        sys.log("In capturing (" + capturing + ") addEventListener with this: " + sys.inspect(this.nodeName));
    },
    ...
    dispatchEvent: function(event) {
        ...
        function _dispatchEvent(event, targets, capturing) {
            sys.log("In _dispatchEvent with targets.length: " + sys.inspect(targets.length) + ", capturing: " + capturing);
